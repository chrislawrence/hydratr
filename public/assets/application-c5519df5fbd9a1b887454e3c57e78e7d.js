...
(function() {
  $(function() {
    ...
    $('#method_hourly').click(function() {
      $.ajax({
        type: 'POST',
        url: 'calculations/preferences',
        data: {
          default_method: 'hourly'
        }
      });
      if ($('.reveal_answer').css('display') === 'none') {
        return $('.daily_answer').css('display', 'none') && $('.hourly_answer').css('display', 'block');
      }
    });
    $('#method_daily').click(function() {
      $.ajax({
        type: 'POST',
        url: 'calculations/preferences',
        data: {
          default_method: 'daily'
        }
      });
      if ($('.reveal_answer').css('display') === 'none') {
        return $('.hourly_answer').css('display', 'none') && $('.daily_answer').css('display', 'block');
      }
    });
    Answer = (function() {
      function Answer() {}
      ...
      Answer.prototype.reveal = function() {
        ...
        if ($('#method_hourly').is(':checked')) {
          $('.hourly_answer').css('display', 'block');
        }
        if ($('#method_daily').is(':checked')) {
          return $('.daily_answer').css('display', 'block');
        }
      };
    ...
    return window.Answer = new Answer;
  });
